            ...
            <div>
                <div className="section top-bar" id="top">
                    ...
                    <div id="menu">
                        ...
                        <a className="faded" id="eng-projects-link" href="https://lilianzlettuce.github.io/engineering-projects">Engineering</a>
                        ...
                        <a className="faded" href="LilianZhaoResumeMay2022.pdf" target="_blank">Resume</a>
                    </div>
                </div>
            </div>
        )
