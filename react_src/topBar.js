        ...
        return (
            <div>
                <div className="top-bar">
                    ...
                    <div id="menu">
                        <a className="faded menu-link" id="work-link" href="https://lilianzlettuce.github.io/work">Work</a>
                        <a className="faded menu-link" id="stuff-link" href="https://lilianzlettuce.github.io/stuff">Gallery</a>
